...
const ledger = JSON.parse(await readFile(new URL("../../steer/evidence/0028-case-ledger-1730e9e.json", import.meta.url), "utf8")) as Record<string, unknown>;
...
test("STR-028 measured ledger closes the exact 20-case denominator and both p95 budgets", () => {
  ...
  assert.equal(ledger.target_commit, "1730e9e98f355ccea80183170b9a6a104f94e3fe");
