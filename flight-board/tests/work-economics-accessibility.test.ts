...
test("rendered Work Economics surface has no serious or critical axe findings", async () => {
  const item = {
    ...
    verification_classification: { classifier_version: "steer.verification-fixture/v1" as const, kind: "OPERATIONAL" as const, is_fixture: false },
  };
