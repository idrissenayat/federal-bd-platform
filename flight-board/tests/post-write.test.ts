...
import { applyAuthoritativeSnapshot, mergeBootstrapPreservingNewerItems } from "../lib/post-write";

type Item = { id: number; updated_at: string; next_action: string };
...
test("an older bootstrap response cannot overwrite a newer confirmed mutation", () => {
