...
async function ensureSeedData(db: Database, user: User) {
  ...
  const seeds = [
    ...
    ["STR-010", "Complete Block Buzz agent operations", "Activate persistent hosted agent workers on the official Block Buzz relay.", "Engineer", "Now", "Setup / excluded", "active", "No gate (setup)", "Not required", "Human owner", user.id, "Validate the reconciled PR #11, record the Builder boundary proof, and present B1 for human review.", "https://github.com/idrissenayat/federal-bd-platform/pull/11", "https://github.com/idrissenayat/federal-bd-platform/issues/10"],
    ...
    ["STR-014", "Build the STEER work-management app", "Create the daily operating surface for humans and agents using the STEER framework.", "Engineer", "Later", "Setup / excluded", "complete", "No gate (setup)", "Not required", "Human owner", user.id, "Complete — PR #15 merged and the operational app is deployed.", "https://github.com/idrissenayat/federal-bd-platform/pull/15", "https://github.com/idrissenayat/federal-bd-platform/issues/14"],
  ];
