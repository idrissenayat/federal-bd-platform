...
**Scope:** STR-017 second-cycle rework after independent Test Agent revision `48a870379418c9bafee0ab5eb726f414c48726eb`
...
- The automated migration test starts from an existing item, applies all three migrations, proves nullable/unknown behavior, query projections, conflict provenance, and trigger enforcement, rolls back the additions/tables/triggers/columns, and confirms original key/title/next action remain intact.
